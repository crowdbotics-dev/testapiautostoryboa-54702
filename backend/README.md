...
## Project Structure
    ...
    ├── testapiautostoryboa_54702  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_54702`
...
2. Clone this repo and `cd testapiautostoryboa_54702`
